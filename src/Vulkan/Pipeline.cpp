...
void Pipeline::createGraphicsPipeline(VulkanContext& context) {
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = 800.0f;  // Esto deber�a venir del swapchain en una versi�n mejorada
    ...
    pipelineLayoutInfo.setLayoutCount = 1; // CAMBIO
    pipelineLayoutInfo.pSetLayouts = &descriptorSetLayout; // CAMBIO
    ...
    // Asignar el layout al pipelineInfo
